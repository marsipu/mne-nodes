...
STYLES = {
    "keyword": qformat("blue"),
    "operator": qformat("red"),
    "brace": qformat("darkGray"),
    "defclass": qformat("black", "bold"),
    "string": qformat("magenta"),
    "string2": qformat("darkMagenta"),
    "comment": qformat("darkGreen", "italic"),
    "self": qformat("black", "italic"),
    "numbers": qformat("brown"),
}
