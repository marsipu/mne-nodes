...
2. To install `mne_nodes` in the conda-enviroment you created in step 1 you can either
    - Install the stable version with `pip install mne_nodes`
...
4. Add upstream to git for
   updates: `git remote add upstream git://github.com/marsipu/mne-nodes.git`
