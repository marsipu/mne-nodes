...
For device-specific settings, such as the number of jobs or if cuda is enabled are stored either with *Settings* in a JSON file located in a OS-dependent directory.
